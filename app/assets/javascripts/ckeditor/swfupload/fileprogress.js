...
var Button = new Class({
  ...
  init: function(){
    ...
    image.src = '/javascripts/ckeditor/assets/' + this.image;
    ...
    var cell = row.insertCell(row.cells.length);
    image = document.createElement('img');
    image.src = '/javascripts/ckeditor/assets/spacer.gif';
...
FileProgress.prototype.createThumbnail = function(serverData) {
  ...
  cell.innerHTML = "<img src='" + image_src + "' alt='" + image_alt + "' title='" + file_name + "' class='image' onerror=\"this.src='/javascripts/ckeditor/assets/ckfnothumb.gif'\" />"
